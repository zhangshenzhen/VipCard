package com.gallerypick.adapter;
...
import com.bjypt.vipcard.activity.PlusImageActivity;
...
import com.gallerypick.utils.ScreenUtils;
...
public class PhotoAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public PhotoAdapter(Activity mActivity, Context mContext, List<PhotoInfo> photoInfoList, ArrayList<String> mPath) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        //选择图片
        viewHolder.chkPhotoSelector.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (!galleryConfig.isMultiSelect()) {
                    selectPhoto.clear();
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putStringArrayListExtra(MainConstant.IMG_LIST, mPath);
                intent.putExtra(MainConstant.POSITION, position - 1);
