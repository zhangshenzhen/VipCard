...
import com.bjypt.vipcard.model.ADInfo;
...
public class CycleViewPager extends Fragment implements ViewPager.OnPageChangeListener{
    ...
    public void setData(List<ImageView> views, List<ADInfo> list, ImageCycleViewListener listener, int showPosition) {
        ...
        for (int i = 0; i < indicators.length; i++) {
            ...
            LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(DensityUtil.dip2px(getActivity(), 10),DensityUtil.dip2px(getActivity(), 10));
    ...
    private void setIndicator(int selectedPosition) {
        for (int i = 0; i < indicators.length; i++) {
            indicators[i]
                    .setBackgroundResource(R.drawable.dian_normal);
        }
        if (indicators.length > selectedPosition)
            indicators[selectedPosition]
                    .setBackgroundResource(R.drawable.dian_click);
    }
