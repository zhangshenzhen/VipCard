...
public  class BannerLayoutManager extends RecyclerView.LayoutManager {
   ...
   private float  moveSpeed=1.0f;
     ...
     */
    public BannerLayoutManager(Context context, int num, int orientation) {
        this(context,num,orientation,false);
    }

    public BannerLayoutManager(Context context, int num, int orientation, boolean reverseLayout) {

        setEnableBringCenterToFront(true);
        setMaxVisibleItemCount(num);//设置可见的个数
