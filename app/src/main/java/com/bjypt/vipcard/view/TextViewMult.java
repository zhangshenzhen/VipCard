...
public class TextViewMult extends LinearLayout {
    List<AnnouncementBean> mTexts; //数据源
    ...
    public TextViewMult(Context context) {
        super(context);
        init(context, null);
    }

    public TextViewMult(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public TextViewMult(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public TextViewMult(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
     ...
     */
    public void setTexts(final List<AnnouncementBean> mTexts, int pageSize) {
        this.mTexts = mTexts;
