package com.bjypt.vipcard.view.layoutbanner;
...
public class BannerLayout extends FrameLayout {
    ...
    public BannerLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        sereen_width = AppInfoUtil.getScreenWidth(context);
    ...
    protected void initView(Context context, AttributeSet attrs) {
        ...
        LayoutParams vpLayoutParams = new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
         ...
         int newLeft = - sereen_width/8 - DensityUtil.dip2px(context, 5);;
        vpLayoutParams.setMargins( newLeft, -10, marginRight, marginBottom);
        //vpLayoutParams.setMarginStart(-140);
        addView(mRecyclerView, vpLayoutParams);
        mLayoutManager = new BannerLayoutManager(getContext(),3, orientation);
