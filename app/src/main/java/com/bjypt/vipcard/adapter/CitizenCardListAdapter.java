...
public class CitizenCardListAdapter extends BaseAdapter {

    private Context context;
    List<CitizenCardListBean.ResultDataBean.BindlistBean> cardInfoList;

    public CitizenCardListAdapter(Context context, List<CitizenCardListBean.ResultDataBean.BindlistBean> cardInfoList) {
