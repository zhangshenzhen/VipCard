package com.bjypt.vipcard.pulltorefresh.social.custom;
...
public class CustomCollapsingNoToolbarLayout extends CollapsingToolbarLayout {
    ...
    public CustomCollapsingNoToolbarLayout(Context context) {
        this(context, null);
    }

    public CustomCollapsingNoToolbarLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CustomCollapsingNoToolbarLayout(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        drawTitleLayout(canvas);
    ...
    private class OffsetUpdateListener implements AppBarLayout.OnOffsetChangedListener {
        ...
        public void onOffsetChanged(AppBarLayout appBarLayout, int verticalOffset) {
            ...
            ViewCompat.postInvalidateOnAnimation(CustomCollapsingNoToolbarLayout.this);
        }
