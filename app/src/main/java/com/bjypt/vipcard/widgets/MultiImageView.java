...
public class MultiImageView extends LinearLayout {
	...
	// 照片的Url列表
	private List<CircleItemBean.ResultDataBean.ListBean.AttachmentsBean> imagesList;
	...
	public void setList(List<CircleItemBean.ResultDataBean.ListBean.AttachmentsBean> lists) throws IllegalArgumentException{
		if(lists==null){
	...
	private ImageView createImageView(int position, final boolean isMultiImage) {
		CircleItemBean.ResultDataBean.ListBean.AttachmentsBean photoInfo = imagesList.get(position);
		...
		imageView.setId(photoInfo.getAid());
		imageView.setOnClickListener(new ImageOnClickListener(position));
		imageView.setBackgroundColor(getResources().getColor(R.color.im_font_color_text_hint));
		Glide.with(getContext()).load(photoInfo.getAttachment()).diskCacheStrategy(DiskCacheStrategy.ALL).into(imageView);
