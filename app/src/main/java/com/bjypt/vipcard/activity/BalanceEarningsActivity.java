...
public class BalanceEarningsActivity extends BaseActivity {
    ...
    public void initView() {
        ...
        tv_finalcial_detail.setText("余额增益");
    ...
    public void afterInitView() {
        ...
        feePointWeb.loadUrl(Config.web.recharge_account_ + getFromSharePreference(Config.userConfig.pkregister) + "&type_main=3");
