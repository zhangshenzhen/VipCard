...
public class BigOneCodeActivity extends BaseActivity implements VolleyCallBack {
    ...
    public void setContentLayout() {
        setContentView(R.layout.activity_big_one_code);
    }
    ...
    private void requestUpdateStatus() {
        ...
        update2 = new Runnable() {
            ...
            public void run() {
                ...
                Wethod.httpPost(BigOneCodeActivity.this, REQUEST_UPDATE_STATUS, Config.web.status, param, BigOneCodeActivity.this, View.GONE);
            ...
            if (status == 3) {
                ...
                dialog.setOnNegativeListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        BigOneCodeActivity.this.finish();
                    }
                });
                dialog.setOnPositiveListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(BigOneCodeActivity.this, LifeServireH5Activity.class);
...
//                ToastUtil.showToast(this, "卡余额不足，请充值");
                ...
                dialog.setOnPositiveListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent1 = new Intent(BigOneCodeActivity.this, OneKeyTopupAmountActivity.class);
