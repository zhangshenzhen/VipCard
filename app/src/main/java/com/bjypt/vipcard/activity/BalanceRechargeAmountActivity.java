 ...
 * Created by 涂有泽 .
 * Date by 2016/6/18
 * Use by 当支付时余额不足,跳转到此页面输入充值金额
 * <p>
 * 定义：当向商家充值时  FLAG = 1;  当向平台充值时 FLAG = 2;
 */
public class BalanceRechargeAmountActivity extends BaseActivity implements VolleyCallBack {
    ...
    public void onClickEvent(View v) {
        switch (v.getId()) {
            ...
            case R.id.tv_login_top_up_amount:
                ...
                if (et_top_up_amount.getText().toString().equals("") || et_top_up_amount.getText().toString() == null) {
                ...
                } else if (Integer.parseInt(et_top_up_amount.getText().toString()) == 0) {
                    ...
                    if (et_top_up_amount.getText().toString().substring(0, 1).equals("0")) {
                        ...
                        params.put("pkpropre", "");
                        Wethod.httpPost(BalanceRechargeAmountActivity.this, 1, Config.web.create_new_order, params, this);
                    }
