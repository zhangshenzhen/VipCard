 ...
 * Use by 全部评论
 */
public class CommentAllFra extends Fragment implements VolleyCallBack{
...
//    private String pkmuser = "61ffdb6c29fd46d8ad1572bbc42ef937";
    ...
    private View view;
    private ImageView iv_defalut_comment_all_pic;

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {

        view=inflater.inflate(R.layout.fra_comment_all, container, false);
    ...
    public void initView(View view){
        iv_defalut_comment_all_pic = (ImageView) view.findViewById(R.id.iv_defalut_comment_all_pic);
        mCommentAllList = (PullToRefreshListView) view.findViewById(R.id.comment_all);
        ...
        if(reqcode == 1){
            ...
            try {
                ...
                if (commentBean.getResultData().size()>0){
                    iv_defalut_comment_all_pic.setVisibility(View.GONE);
    ...
    public void onResume() {
        super.onResume();
        UmengCountContext.onPageStart("CommentAllFra");
    }

    @Override
    public void onPause() {
        super.onPause();
        UmengCountContext.onPageEnd("CommentAllFra");
    }
}
