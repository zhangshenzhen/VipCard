...
public class CfRecommentProjectItemDataBeanNew {
    ...
    private String msg;
    private List<CfProjectItemNew> resultData;
    ...
    public List<CfProjectItemNew> getResultData() {
        return resultData;
    }

    public void setResultData(List<CfProjectItemNew> resultData) {
