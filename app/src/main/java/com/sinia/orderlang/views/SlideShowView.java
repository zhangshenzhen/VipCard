...
import com.sinia.orderlang.utils.UIL;
import com.sinia.orderlang.utils.Utils;
import com.sinia.orderlang.views.EditViewPager.OnItemTouchListener;
...
public class SlideShowView extends FrameLayout {
	...
	public SlideShowView(Context context, AttributeSet attrs, int defStyle) {
		...
		LayoutInflater.from(context).inflate(R.layout.layout_slideshow, this,
				true);
		uOption = UIL.getOptions(R.drawable.default_img);
	...
	private void initUI() {
		...
		for (int i = 0; i < imageUrls.size(); i++) {
			...
			lp.setMargins(Utils.dip2px(context, 6), Utils.dip2px(context, 0),
					Utils.dip2px(context, 6), Utils.dip2px(context, 0));
		...
		public Object instantiateItem(View container, final int position) {
			...
			if (!("").equals(imageUrls.get(pos))) {
				ImageLoader.getInstance().displayImage(imageUrls.get(pos),
						view, uOption);
				BitmapUtilsHelp.getImage(context, R.drawable.default_img)
	...
	public void setOnItemClickListener(
		...
		viewPager.setOnItemTouchListener(new OnItemTouchListener() {
