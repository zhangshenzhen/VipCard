...
public class SelectAddress2Fragment extends BaseFragment implements
	...
	private void initView() {
		...
		rootView = inflater.inflate(R.layout.fragment_selectcity, null);
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int position,
		...
		case 3:
			...
			SeckillFragment.city = selectedCity;
			SeckillFragment.areaName = selectedTown;
			Log.d("lamp", "SeckillFragment.city=" + SeckillFragment.city
					+ ",SeckillFragment.areaName=" + SeckillFragment.areaName);
			...
			adapter.check = chooseIndex3;
			adapter.notifyDataSetChanged();
			goodsDetailActivity.handler.sendEmptyMessage(100);
			Message msg = goodsDetailActivity.handler.obtainMessage();
			msg.obj = selectedProvince + " " + selectedCity + " "
					+ selectedTown;
			msg.what = 103;
			goodsDetailActivity.handler.sendMessage(msg);
			break;
		}
	}
