...
public class SpecialPriceFra extends Fragment{
...
//            finish();
            ...
            if (city.equals("-1")) {
                tv_area.setText(SharedPreferenceUtils.getFromSharedPreference(getActivity(), Config.userConfig.cname));
            } else {
...
//        }
    ...
    private void teJiaList(int begin,int pageLength) {
        ...
        request.setCity(SharedPreferenceUtils.getFromSharedPreference(getActivity(), Config.userConfig.citycode));
...
//                            adapter.notifyDataSetChanged();
   ...
   /* @Override
    ...
    private void initView() {
        ...
        areaName = "-1";
        city = "-1";
        specialAddess = SharedPreferenceUtils.getFromSharedPreference(getActivity(), Config.userConfig.pname)+SharedPreferenceUtils.getFromSharedPreference(getActivity(), Config.userConfig.cname);
//        +SharedPreferenceUtils.getFromSharedPreference(SpecialPriceMainActivity.this, Config.userConfig.adName
        ...
        // 设置定位监听
//        locationClient.setLocationListener(getAct);
        listview = (PullToRefreshListView) view.findViewById(R.id.listview);
        listview.setMode(PullToRefreshBase.Mode.BOTH);
        location_special = (RelativeLayout)view. findViewById(R.id.location_special);

        order_list_lang = (ImageView) view.findViewById(R.id.order_list_lang);
        shop_lang = (ImageView) view.findViewById(R.id.shop_lang);

        tv1 = (TextView)view. findViewById(R.id.tv1);
        tv_classify = (TextView) view.findViewById(R.id.tv_classify);
        tv_area = (TextView) view.findViewById(R.id.tv_area);
        back = (ImageView) view.findViewById(R.id.back_special);
        search = (ImageView)view. findViewById(R.id.search);
        rl_classify = (RelativeLayout) view.findViewById(R.id.rl_classify);
        rl_sifting = (RelativeLayout)view. findViewById(R.id.rl_sifting);
        rl_area = (RelativeLayout) view.findViewById(R.id.rl_area);
        adapter = new SpecialOfferAdapter(getActivity());
       ...
       /* back.setOnClickListener(getActivity());
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if(SharedPreferenceUtils.getFromSharedPreference(getActivity(),Config.userConfig.is_Login).equals("Y")){
                    // 跳转到特价商品详情页
